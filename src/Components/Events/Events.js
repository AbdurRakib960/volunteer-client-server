...
const Events = () => {
    ...
    useEffect(()=>{
        fetch('https://sleepy-everglades-33531.herokuapp.com/my-events',{
            method:'GET', 
            headers:{
    ...
    const calcelEventHandler=(id)=>{
        fetch('https://sleepy-everglades-33531.herokuapp.com/cancel-event',{
            method:'DELETE',
            headers:{
                'Content-Type':'application/json',
                id:id
                       ...
                       return(
                            ...
                            style={{boxShadow:'0px 2px 5px lightGray', borderRadius:'10px', width:'100%',margin:'10px'}}>
                                <Grid item xs={10} md={5} style={{width:'50%'}}>
                                    <img style={{width:'100%', height:'180px'}} src={event.image} alt=""/>
                                </Grid>
