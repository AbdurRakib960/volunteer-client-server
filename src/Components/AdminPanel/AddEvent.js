...
const AddEvent = () => {
    const [myEvent, setMyEvent]=useState({date:new Date().toDateString(),image:'https://imgur.com/XDR2o8k.png'})
    const history=useHistory()
    
    const addEventHandler=()=>{
        fetch('https://sleepy-everglades-33531.herokuapp.com/add-event',{
            method:'POST',
